        ...
        implements Metadata
{
    ...
    public List<String> listSchemaNames(Session session, String catalogName)
    {
        ...
        if (!schemaNamesJson.equals(EMPTY_STRING)) {
            return readValue(schemaNamesJson, new TypeReference<List<String>>() {});
        }
    ...
    public List<QualifiedObjectName> listTables(Session session, QualifiedTablePrefix prefix)
    {
        ...
        if (!tableListJson.equals(EMPTY_STRING)) {
            return readValue(tableListJson, new TypeReference<List<QualifiedObjectName>>() {});
        }
        return new ArrayList<>();
    }
    ...
    public List<QualifiedObjectName> listViews(Session session, QualifiedTablePrefix prefix)
    {
        ...
        if (!viewsListJson.equals(EMPTY_STRING)) {
            return readValue(viewsListJson, new TypeReference<List<QualifiedObjectName>>() {});
        }
        return new ArrayList<>();
    }
    ...
    public Map<QualifiedObjectName, ViewDefinition> getViews(Session session, QualifiedTablePrefix prefix)
    {
        ...
        if (!viewsMapJson.equals(EMPTY_STRING)) {
            return readValue(viewsMapJson, new TypeReference<Map<QualifiedObjectName, ViewDefinition>>() {});
        }
        return new HashMap<>();
    }
    ...
    public Optional<ViewDefinition> getView(Session session, QualifiedObjectName viewName)
    {
        ...
        if (!viewDefinitionJson.equals(EMPTY_STRING)) {
            ViewDefinition viewDefinition = readValue(viewDefinitionJson, new TypeReference<ViewDefinition>() {});
    ...
    public Optional<ConnectorMaterializedViewDefinition> getMaterializedView(Session session, QualifiedObjectName viewName)
    {
        ...
        if (!connectorMaterializedViewDefinitionJson.equals(EMPTY_STRING)) {
            ConnectorMaterializedViewDefinition connectorMaterializedViewDefinition =
                    readValue(connectorMaterializedViewDefinitionJson, new TypeReference<ConnectorMaterializedViewDefinition>() {});
    ...
    @Override
    public void createMaterializedView(Session session,
            String catalogName,
    ...
    public List<QualifiedObjectName> getReferencedMaterializedViews(Session session, QualifiedObjectName tableName)
    {
        ...
        if (!referencedMaterializedViewsListJson.equals(EMPTY_STRING)) {
            return readValue(referencedMaterializedViewsListJson, new TypeReference<List<QualifiedObjectName>>() {});
        }
        return new ArrayList<>();
    }
