...
public class AllNodes
{
    ...
    public AllNodes(Set<InternalNode> activeNodes, Set<InternalNode> inactiveNodes, Set<InternalNode> shuttingDownNodes, Set<InternalNode> activeCoordinators, Set<InternalNode> activeResourceManagers, Set<InternalNode> activeCatalogServers)
    {
