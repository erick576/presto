...
public class TestDiscoveryNodeManager
{
    ...
    public void setup()
    {
        ...
        resourceManager = new InternalNode(resourceManagerNodeInfo.getNodeId(), URI.create("https://192.0.2.9"), expectedVersion, false, true, false);
        catalogServer = new InternalNode(catalogServerNodeInfo.getNodeId(), URI.create("https://192.0.3.1"), expectedVersion, false, false, true);
        ...
        inActiveResourceManager = new InternalNode(resourceManagerNodeInfo.getNodeId(), URI.create("https://192.0.2.9"), new NodeVersion("2"), false, true, false);
        inActiveCatalogServer = new InternalNode(catalogServerNodeInfo.getNodeId(), URI.create("https://192.0.3.2"), new NodeVersion("2"), false, false, true);
